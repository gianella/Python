...
def idolo():
    ...
    opcion1.grid(row=0, column=2)
    opcion2 = Button(explo,text="Si Decides despreocuparte de INCU ", fg='yellow', font='Arial', bg='BLUE',command=explorar,width=70, height=5)
    opcion2.grid(row=2, column=2)
    explo.mainloop()
...
def nohacereso():
    ...
    bientext = Label(ayuda, image=imagen2)
    bientext.grid(row=1, column=2)
    opcion1 = Button(ayuda,text="Si tratas de escapar con angus", fg='yellow', font='Arial', bg='BLUE',command=dormir, width=70, height=5)
    opcion1.grid(row=0, column=2)
    opcion2 = Button(ayuda,text="Si tratas de hallar otra solucion", fg='yellow', font='Arial', bg='BLUE',command=explorar,width=70, height=5)
    opcion2.grid(row=2, column=2)
    ayuda.mainloop()
